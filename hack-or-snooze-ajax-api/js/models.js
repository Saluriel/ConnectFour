...
class StoryList {
  ...
  async addStory(user, {title, author, url}) {
    ...
    // console.log(token)
    //make a POST request to the stories to add the story
...
class User {
  ...
  isFavorite(story){
    ...
    // this.favorites.some(function(e){
    //   return e.storyId === story.storyId;
    // })
  }
